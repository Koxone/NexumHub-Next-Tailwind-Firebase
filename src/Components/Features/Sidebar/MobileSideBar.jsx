    ...
    <>
      ...
      >
        ...
        {/* <button
          ...
          className="absolute end-2.5 top-2.5 inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-text-primary"
        >
          <svg
            aria-hidden="true"
            className="h-5 w-5"
