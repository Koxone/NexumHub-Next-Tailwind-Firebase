...
export default function ExperienceSection() {
  ...
  return (
    <section className="mx-auto flex h-[100dvh] flex-col items-center justify-center gap-8 sm:max-w-[575px] md:max-w-full">
      ...
      <div className="group relative flex w-full transform flex-col items-center justify-center overflow-hidden rounded-2xl border border-blue-400 bg-white/5 p-10 text-left text-base leading-relaxed text-neutral-200 backdrop-blur-sm transition-all duration-500 ease-in-out hover:scale-[1.02] hover:border-blue-400 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] sm:border-neutral-600">
        ...
        <div className="relative z-10 w-full">
          ...
          <div className="mt-8 border-t border-neutral-700 pt-6">
            <div className="flex flex-wrap gap-3">
              {[
                { key: 'react', color: 'bg-blue-400/20 text-blue-300' },
                ...
                { key: 'firebase', color: 'bg-yellow-400/20 text-[#1E90FF]' },
